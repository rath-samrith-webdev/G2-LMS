		...
		<div class="col-12">
			<div class="card ctm-border-radius shadow-sm grow">
				...
				<div class="card-body">
					...
					<a href="javascript:void(0)" class=" button-1 btn btn-theme text-white ctm-border-radius float-right mx-2  mt-2"> Visit Office</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card-body">
					<div class="media mb-4">
						...
						<div class="media-body">
							...
							<p class="ctm-text-sm mb-0 text-ellipsis"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1a687379727b687e6d73766975745a7f627b776a767f34797577">[email&#160;protected]</a></p>
						</div>
					</div>
					<div class="text-center">
						<a href="javascript:void(0)" class=" button-1 btn btn-theme ctm-border-radius text-white" data-toggle="modal" data-target="#changeManger">Change Manager</a>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-6 col-sm-12 d-flex">
			<div class="card add-team flex-fill ctm-border-radius shadow-sm grow">
				...
				<div class="card-body">
					...
					<a href="employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="Richard Wilson"><img class="img-fluid" alt="avatar image" src="assets/img/profiles/img-10.jpg"></span></a>
					<div class="text-center">
						<a href="javascript:void(0)" class=" button-1 btn btn-theme ctm-border-radius text-white mt-4" data-toggle="modal" data-target="#addPeople">Add People</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-6 col-sm-12 d-flex">
			<div class="card flex-fill ctm-border-radius shadow-sm grow">
				...
				<div class="card-body">
					...
					<p class="button-1 btn btn-theme ctm-border-radius text-white mb-1">PHP Team Lead</p>
					<p class="btn btn-theme button-1 ctm-border-radius text-white mb-1">Permanent</p>
				</div>
			</div>
		</div>
		<div class="col-md-6 col-sm-12 d-flex">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<button type="button" class="btn btn-theme text-white ctm-border-radius text-center mb-2 button-1" data-dismiss="modal">Delete</button>
			</div>
		</div>
	</div>
</div>
